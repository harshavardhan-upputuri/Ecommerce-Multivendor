                ...
                <TableBody>
                    {transaction.transactions.map((item) => (
                        <StyledTableRow key={item.id}>
                            ...
                            <StyledTableCell align="right">{item.order ? item.order.id : 0}</StyledTableCell>
                            <StyledTableCell align="right">{item.order?item.order.totalSellingPrice:0}</StyledTableCell>
                        </StyledTableRow>
                    ))}
                </TableBody>
            </Table>
