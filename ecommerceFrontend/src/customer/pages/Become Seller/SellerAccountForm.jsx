...
const SellerAccountForm = () => {
    ...
    const handleStep = (step) => {
        (activeStep < steps.length - 1 || (activeStep > 0 && step == -1)) && setActiveStep(activeStep + step);
        ...
        <div>
            ...
            <section className='mt-20 space-y-10'>
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <Button onClick={() => handleStep(1)} variant='contained'>{activeStep == steps.length - 1 ? "Create Account" : "continue"}</Button>
                </div>
