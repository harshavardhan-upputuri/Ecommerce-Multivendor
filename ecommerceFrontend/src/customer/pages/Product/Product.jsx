        ...
        <div className='-z-10 mt-10'>
            ...
            <div className='lg:flex'>
                ...
                <div className='w-full lg:w-[80%] space-y-5'>
                    ...
                    <Divider />
                    <section className="products_section grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-5 px-8 justify-center">
                        {product.products.map((item, index) => <ProductCard  item={item}/>)}
